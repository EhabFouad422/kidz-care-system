      ...
      <div className="hidden lg:flex flex-col justify-between w-2/5 bg-gradient-to-br from-slate-900 via-violet-950 to-slate-900 p-10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-pink-400 to-violet-600 flex items-center justify-center">
              <Heart className="w-6 h-6 text-white" fill="white" />
            </div>
            <div>
              <p className="text-white font-extrabold text-xl tracking-tight">Kidz Care</p>
              <p className="text-slate-400 text-xs">Pediatric Management System</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-slate-50">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="lg:hidden text-center">
            <div className="inline-flex w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-400 to-violet-600 items-center justify-center mb-3">
              <Heart className="w-7 h-7 text-white" fill="white" />
            </div>
            <h1 className="text-xl font-bold text-slate-900">Kidz Care</h1>
          </div>
